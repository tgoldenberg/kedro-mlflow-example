...
# kedro_mlflow_example documentation build
...
from kedro_mlflow_example import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_mlflow_example"
copyright = "2018-2019, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "kedro_mlflow_exampledoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_mlflow_example.tex",
        "kedro_mlflow_example Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_mlflow_example",
        "Project kedro_mlflow_example codebase.",
        "Data-Science",
    )
]
